#ifndef HALIDE__include___archinizator_h
#define HALIDE__include___archinizator_h
#include <stdint.h>
...
int generate(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_logo_buffer, struct halide_buffer_t *_cpu___output_buffer) HALIDE_FUNCTION_ATTRS;
int generate_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *generate_metadata() HALIDE_FUNCTION_ATTRS;
